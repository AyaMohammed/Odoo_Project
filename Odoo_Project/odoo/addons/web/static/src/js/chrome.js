...
instance.web.CrashManager = instance.web.Class.extend({
    ...
    rpc_error: function(error) {
        ...
        if (error.data.name === "openerp.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
            this.show_warning({type: "Session Expired", data: { message: _t("Your ZoserCRM session expired. Please refresh the current web page.") }});
            return;
        }
    ...
    show_warning: function(error) {
        ...
        new instance.web.Dialog(this, {
            size: 'medium',
            title: "ZoserCRM " + (_.str.capitalize(error.type) || "Warning"),
            buttons: [
    ...
    show_error: function(error) {
        ...
        new instance.web.Dialog(this, {
            title: "ZoserCRM " + _.str.capitalize(error.type),
            buttons: buttons
...
instance.web.UserMenu =  instance.web.Widget.extend({
    ...
    on_menu_help: function() {
        window.open('http://www.zosersolutions.com', '_blank');
    },
...
instance.web.WebClient = instance.web.Client.extend({
    init: function(parent, client_options) {
        ...
        this.set('title_part', {"zopenerp": "Zoser CRM"});
    },
    start: function() {
        var self = this;
 ...
 * ZoserCRM webclient in an iframe, using the Cordova framework.
 *
 * This class acts as a link between the webclient and the
 * ZoserCRM Android/iPhone App implemented with cordova.
 */
