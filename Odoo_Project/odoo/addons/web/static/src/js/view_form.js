...
instance.web.form.FieldMany2One = instance.web.form.AbstractField.extend(instance.web.form.CompletionFieldMixin, instance.web.form.ReinitializeFieldMixin, {
    ...
    render_editable: function() {
        ...
        this.$follow_button.hover(function(ev_over) {
            if (self.string){
                var field_name = self.string;
            } else {
                var field_name = '';
            }

            if (self.current_display) {
                var field_value = self.current_display
            } else {
                var field_value = '';
            }

            var tooltip_text = 'Show more details about '+field_name+': '+field_value;
            self.$follow_button.tooltip('hide')
