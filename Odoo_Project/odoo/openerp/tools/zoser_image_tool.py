# -*- coding: utf-8 -*-
##############################################################################
# Image Resizing Enterprise solution Department
# Zoser Solution
# Developer: Mostafa Abd El Fattah
##############################################################################
...
def image_resize_image_medium(base64_source, size=(900, 600), encoding='base64', filetype=None, avoid_if_small=False):
...
def image_resize_blue_print(base64_source, size=(400, 400), encoding='base64', filetype=None, avoid_if_small=False):
    """ Wrapper on image_resize_image, to resize to the standard 'medium'
        image size: 180x180.
        :param size, encoding, filetype, avoid_if_small: refer to image_resize_image
    """
...
def image_resize_image_small(base64_source, size=(40, 40), encoding='base64', filetype=None, avoid_if_small=False):
...
def image_get_resized_images(base64_source, return_big=False, return_medium=True, return_small=True, return_blueprint=True,
    big_name='image', medium_name='image_medium', small_name='image_small', blue_print='blueprint',
    avoid_resize_big=True, avoid_resize_medium=False, avoid_resize_small=False, avoid_resize_blueprint=False):
    ...
    if return_blueprint:
        return_dict[blue_print] = image_resize_blue_print(base64_source, avoid_if_small=avoid_resize_blueprint)
    if return_small:
